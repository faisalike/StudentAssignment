...
using StudentAssignment.DAL.Repository;
...
namespace StudentAssignment
{
    public class Startup
    {
        ...
        {
            string connectionString = Configuration.GetConnectionString("StudentCon");
            services.AddDbContext<StudentDBContext>(options => options.UseSqlServer(connectionString));
            // we will register in saprate file for simplicity
